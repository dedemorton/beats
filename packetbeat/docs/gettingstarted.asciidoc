...
curl -L -O https://download.elastic.co/beats/packetbeat/packetbeat-{version}-amd64.deb
...
["source","sh",subs="attributes,callouts"]
----------------------------------------------------------------------
curl -L -O https://download.elastic.co/beats/packetbeat/packetbeat-{version}-darwin-x86_64.tar.gz
