...
//requires libbeat-configuration-fields,configuration-dashboards, load-template-manually
//securing-newbeat, configuration-template
include::../../libbeat/docs/outputconfig.asciidoc[]

//requires setup-kibana-endpoint, configuring-ssl-logstash, and configuring-output
